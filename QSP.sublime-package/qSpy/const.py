...
_t = {
	...
	"modobj": "MODOBJ [$название],[$описание],[$изображение] — замена описания и изображения предмета в инвентаре.",
	...
	"resetobj": "RESETOBJ [$название] — сброс описания и изображения предмета в инвентаре до изначальных.",
	...
	"$curobjs": "$CUROBJS - возвращает в виде кода все текущие предметы",
