...
- [ ] выгрузка всех текстовых констант из игры с **возможностью загрузить обратно!**
	* [x] выгрузка (экспорт) реализована в виде вспомогательных скриптов
	* [ ] загрузка (импорт) исправленных текстовых констант на уровне скриптов
	* [ ] выгрузка и загрузка в виде тулз в меню сублайма
- [x] конвертирование базовых действий и описаний в обе стороны! (Вопросом занимается Байт. **Новый формат TXT2GAM**)
* [ ] ???
