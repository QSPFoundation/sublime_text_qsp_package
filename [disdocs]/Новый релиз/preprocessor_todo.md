...
5. Невалидная директива воспринимается препроцессором, как спецкомментарий.
6. Блоки условий, образованные директивами препроцессора, вкладывать друг в друга нельзя.
7. Имена меток и значений могут содержать только числа, буквы и символ подчёркивания, и не должны совпадать с ключевыми словами директив препроцессора.
8. имена меток и ключевые слова регистрозависимы. `NoSaveComm` и `nosavecomm` — разные слова. Первое может быть именем метки, а второе только ключевым словом директивы препроцессора.
